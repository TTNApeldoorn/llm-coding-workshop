...
## 1. Purpose
This Code of Conduct outlines expectations for all contributors to the LLM Coding Workshop repository (IoT Apeldoorn) to ensure a welcoming, professional, and inclusive environment.
